...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=aa6a98a09676c111e1700d440c1cf4a1'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyAfQuJUiD6JORykcNyAHQCeBqQgI4klIRk'

    SEARCH_ENGINE_ID = 'a1d3b122c78a845b7'
